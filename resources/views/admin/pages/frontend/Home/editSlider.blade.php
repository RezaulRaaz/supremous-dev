        ...
        <div class="col-xl-12 col-lg-12 mt-5">
            <section id="component-swiper-navigations">
                <div class="card ">
                    ...
                    <h4 class="card-title">Edit Slider</h4> <span><a class="btn btn-primary" href="{{route('admin.frontend.home')}}">Add New</a></span>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-4 col-sm-12">
                                <form enctype="multipart/form-data" action="{{route('admin.frontend.slider.update',$singleSlider->id)}}" method="post">
                                    @csrf
                                    <div class="row">
                                        <div class="col-lg-9">
                                            <div class="form-group">
                                                <label for="name">Slider Title</label>
                                            <input value="{{$singleSlider->title}}" type="text" class="form-control" placeholder="Slider Title" name="Slider_title" id="name" aria-describedby="emailHelp">
                                            </div>
                                           </div>
                                        <div class="col-lg-3">
                                            <div class="form-group">
                                                <label for="exampleFormControlFile1">Text Color</label>
                                                <input value="{{$singleSlider->text_color}}" type="color" name="text_color" class="form-control" id="exampleFormControlFile1">
                                            </div>
                                           </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                           ...
                                           <div class="row">
                                               <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{$singleSlider->button_label}}" type="text" name="button_label" class="form-control" id="exampleFormControlFile1">
                                                </div>
                                               </div>
                                               <div class="col-lg-3">
                                                <div class="form-group">
                                                    <label for="exampleFormControlFile1">Btn Bg Color</label>
                                                    <input value="{{$singleSlider->bg_color}}" type="color" name="bg_color" class="form-control" id="exampleFormControlFile1">
                                                </div>
                                               </div>
                                               <div class="col-lg-3">
                                                <div class="form-group">
                                                    <label for="exampleFormControlFile1">Btn Text Color</label>
                                                    <input value="{{$singleSlider->btn_color}}" type="color" name="btn_text_color" class="form-control" id="exampleFormControlFile1">
                                                </div>
                                               </div>
                                           </div>
                                            <div class="form-group">
                                                <label for="exampleFormControlFile1">Button Url</label>
                                                <input type="text" value="{{$singleSlider->btn_url}}" name="btn_url" class="form-control" id="exampleFormControlFile1">
                                            </div>
                                        </div>
                                    </div>
