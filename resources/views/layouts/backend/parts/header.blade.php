        ...
        <div class="navbar-container content">
            <div class="navbar-collapse" id="navbar-mobile">
                ...
                <ul class="nav navbar-nav float-right">
                    ...
                    <div class="user-nav d-sm-flex d-none"><span class="user-name text-bold-600">{{Auth::User()->name}}</span><span class="user-status">{{Auth::User()->role->name}}</span></div><span><img class="round" src="{{imgPath('profile/'.Auth::User()->avatar)}}" alt="avatar" height="40" width="40"></span>
                        </a>
